...
alias td4a="docker run --rm -d -p 5000:5000 --name td4a cidrblock/td4a"
...
alias vd1="viddy -n 1 " # Extra space needed for alias expansion
alias vd2="viddy -n 2 " # Extra space needed for alias expansion
